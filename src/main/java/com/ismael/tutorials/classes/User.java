...
public class User {
    ...
    // Fields - By Default, all fields use the access-type 'protected' (which is a mix of private and public) if we don't declare the access-type.
    String name;
    ...
    // 'static' fields are class variables that are shared across all objects created using the class
